...
const SignupForm = props => {
  ...
  return (
    <div className={`theme-${props.scope}`}>
      ...
      <Form scrollToFirstError={true} onFinish={onFinish} className="login--form signup--form" validateTrigger="onBlur">
        <Form.Item
        ...
        <Button size="small" type="link" onClick={() => props.setCurrent(0)} style={{ width: 'calc(100% - 220px)', marginRight: 10, textAlign: 'right', marginTop: 20 }}>
          regresar
        </Button>
        <Button htmlType="submit" size="small" type="primary" style={{ width: '200px' }}>
          Crear cuenta
        </Button>
      </Form>
    </div>
