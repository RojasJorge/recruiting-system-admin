  ...
  return (
    <>
      ...
      <div className="col col-md-4">
        ...
        <Item name="birthday" rules={[{ required: true, message: 'El campo Fecha de nacimiento es requerido.' }]}>
      ...
      <div className="col col-md-4">
        ...
        <Item name="marital_status" rules={[{ required: true, message: 'El campo Estado civil es requerido.' }]}>
          <Select name="marital_status" size="large" placeholder="Seleccione" style={{ width: '100%' }}>
