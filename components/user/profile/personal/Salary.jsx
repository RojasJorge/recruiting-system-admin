  ...
  return (
    <>
      ...
      <div className="col">
        ...
        <FormItem name="currency" rules={[{ required: true, message: 'El campo Moneda es requerido.' }]}>
      ...
      <div className="col">
        ...
        <FormItem name="min" rules={[{ required: true, message: 'El campo Monto Mínimo es requerido.' }]}>
          <InputNumber min={0} size="large" style={{ width: '100%' }} />
        </FormItem>
      </div>
      <div className="col">
        <label htmlFor="max">Máximo:</label>
        <FormItem name="max" rules={[{ required: true, message: 'El campo Monto Máximo es requerido.' }]}>
          <InputNumber min={0} size="large" style={{ width: '100%' }} />
        </FormItem>
      </div>
      {/*</Form>*/}
