...
const Location = ({country, selectCountry, location, addLocation}) => {
	...
	const selectHandler = (e, type) => {
		switch (type) {
			...
			case "province":
				addLocation({
					...location, province: find(country.data, o => o.id === e),
					city: {
						name: "",
						slug: ""
					}
	...
	return (
		<>
			...
			<div className="col">
				...
				<FormItem
					name="country"
					rules={[{required: true, message: "El campo País es requerido."}]}
				>
					<Select
						name="country"
			...
			<div className="col">
				...
				>
					<Select
						name="province"
						placeholder="Seleccione"
						onChange={e => selectHandler(e, "province")}
						style={{width: '100%'}}
						size="large"
						showSearch
					>
			...
			<div className="col">
				...
				<FormItem
					name="city"
					rules={[{required: true, message: "El campo Municipio es requerido."}]}
				>
					<Select
						name="city"
						placeholder="Seleccione"
						onChange={e => selectHandler(e, "city")}
						style={{width: '100%'}}
						size="large"
						showSearch
					>
			...
			<div className="col-md-4">
				...
				<FormItem
					name="zone"
					rules={[{required: true, message: "El campo Zona es requerido."}]}
				>
