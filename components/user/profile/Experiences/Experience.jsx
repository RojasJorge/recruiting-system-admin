...
const Experience = ({ count, experience, experiences, addExperiences }) => {
  ...
  return (
    <>
      ...
      <Form name="experiences" onFinish={onFinish} style={{ marginTop: 24 }} scrollToFirstError={true}>
        <fieldset>
          <legend>
            <Button shape="circle">{count}</Button> <small>{_experience._id}</small>
          </legend>
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <Item name="area" rules={[{ required: true, message: 'Especifíque un área.' }]}>
                <Select style={{ width: '100%' }} size="large" placeholder="Seleccione"></Select>
              </Item>
            </div>
            <div className="col-md-4">
              <label htmlFor="area">Profesión:</label>
              <Item name="profession" rules={[{ required: true, message: 'Especifíque una profesión.' }]}>
                <Select style={{ width: '100%' }} size="large" placeholder="Seleccione"></Select>
              </Item>
            </div>
            <div className="col-md-4">
              <label htmlFor="specialization">Especialización:</label>
              <Item name="specialization" rules={[{ required: true, message: 'Especifíque una especialización.' }]}>
                <Select style={{ width: '100%' }} size="large" placeholder="Seleccione"></Select>
              </Item>
            </div>
            <div className="col-md-6">
              <label htmlFor="company">Empresa:</label>
              <Item name="company" rules={[{ required: true, message: 'Especifíque una empresa.' }]}>
                <Input size="large" />
              </Item>
            </div>
            <div className="col-md-6">
              <Item label="Teléfono de la empresa" name="company_phone" rules={[{ required: true, message: 'El campo teléfono es requerido' }]}>
                <Cleave
            ...
            <div className="col-md-12">
              ...
              <Item name="specialization_company" rules={[{ required: true, message: 'Este campo es requerido' }]}>
                <Input size="large" />
              </Item>
            </div>
            <div className="col-md-12">
              ...
              <fieldset>
                ...
                <div className="row">
                  <div className="col-md-4">
                    ...
                    <Item name="currency">
                      <Select size="large" placeholder="Seleccione"></Select>
                    </Item>
                  </div>
            ...
            <div className="col-md-12">
              <p>Esta información no se verá en tu perfil, pero la podrán ver futuros reclutadores de plazas en las que apliques.</p>
            </div>
            <div className="col-md-12">
            ...
            <div className="col-md-12">
              <p>Indica aquí información de tus jefes inmediatos en este puesto. Esta información no se verá en tu perfil, pero la podrán ver futuros reclutadores de plazas en las que apliques.</p>
            ...
            {!isEmpty(bosses) ? (
              <div className="col-md-11 offset-md-1">
                {bosses.map((boss, i) => (
                  <Boss key={i} bosses={bosses} addBosses={addBosses} boss={boss} counter={i + 1} _experience={_experience} setExperience={setExperience} />
                ))}
              </div>
            ) : (
              <div className="col-md-12">
          ...
          <Divider></Divider>
          <Button size="large" htmlType="submit" icon={<EnterOutlined />}>
            Confirmar
          </Button>
        </fieldset>
      </Form>
