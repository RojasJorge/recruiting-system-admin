...
const Level = ({ level, counter, careers, academicLevels, addLevels, levels }) => {
  ...
  const onDatePickerChange = (date, dateString, field) => _setLevel({ ..._level, [field]: date.toString() });
  ...
  return (
    <>
      <Form validateTrigger="onBlur" onFinish={onFinish} scrollToFirstError={true}>
        <fieldset>
          <legend>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <Item name="start_date" rules={[{ required: true, message: 'Fecha de inicio es requerida' }]}>
                <DatePicker
                  format="DD/MM/YYYY"
            ...
            <div className="col-md-6">
              <Item name="end_date" rules={[{ required: true, message: 'Fecha final es requerida' }]}>
                <DatePicker
            ...
            <div className="col-md-12">
              ...
              <Item name="collegiate" rules={[{ required: true, message: 'Número de colegiado es requerido.' }]}>
